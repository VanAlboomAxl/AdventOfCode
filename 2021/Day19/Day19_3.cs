...
//                }
//                //foreach((var key, var t) in Rotation)
//                //{
//                //    Console.WriteLine(key + ": " + t.Item1 + "," + t.Item2);
//                //}

//                List<int> rotP2 = new() { 0, 0, 0 };
//                for (int i = 0; i < 3; i++)
//                    rotP2[i] = l2[Rotation[i].Item1] * Rotation[i].Item2;
//                //rotP2.ForEach(i => Console.Write("{0}\t", i)); Console.WriteLine();
//                //l1.ForEach(i => Console.Write("{0}\t", i)); Console.WriteLine();
//                //l2.ForEach(i => Console.Write("{0}\t", i)); Console.WriteLine();
                

//                List<int> Translation = new();
//                for (int i = 0; i < 3; i++)
//                    Translation.Add(rotP2[i] - l1[i]);
//                //Translation.ForEach(i => Console.Write("{0}\t", i));
//                //Console.WriteLine();
...
//            Console.WriteLine(KnownBeacons.Count());
//            Console.WriteLine("-------------");
//            //var sortedList = KnownBeacons.OrderBy(x=>x.Position.Y).OrderBy(x => x.Position.X);
...
//                for (int i = 0; i < p1_mod.Count; i++)
//                {
//                    int iAbs = Math.Abs(p1_mod[i]);
//                    Connections.Add((p1_mod[i], p2_mod[IndexOfClosest(p1_mod[i], p2_mod_abs)]));
//                    //Connections.Add((p1_mod[i], p2_mod[p2_mod_abs.IndexOf(iAbs)]));
//                }

//                Coord c1 = new(Connections[0].Item1,
//                                    Connections[1].Item1,
//                                    Connections[2].Item1);
//                Coord c2 = new(Connections[0].Item2,
//                                    Connections[1].Item2,
//                                    Connections[2].Item2);

//                int iFactorX = (int)Math.Round((decimal)c1.X / c2.X);
//                int iFactorY = (int)Math.Round((decimal)c1.Y / c2.Y);
//                int iFactorZ = (int)Math.Round((decimal)c1.Z / c2.Z);
...
//                //List<int> Translation = new();
//                //Translation.Add(rotP2.X - b1.Position.X);
//                //Translation.Add(rotP2.Y - b1.Position.Y);
//                //Translation.Add(rotP2.Z - b1.Position.Z);
